    ...
    <div class="subnav">
      <div class="container clearfix">
        <h1>
          ...
          <span class="info">/</span> Add Department
        </h1>
        <div class="btn-placeholder">
          ...
          <input type="submit" class="hidden" value="Save Changes" name="btn_add_city" id="btn_save">
        </div>
      </div>
    </div>
