    ...
    <div class="subnav">
      <div class="container clearfix">
        <h1>
          ...
          <a href="<?php echo $prefix_url."career-department"?>">Department</a> 
          <span class="info">/</span> <?php echo $category['category_name'];?>
        </h1>
        <div class="btn-placeholder">
          <input type="hidden" name="cat_id" id="category_id"/>
          <a href="<?php echo $prefix_url."career-department";?>"><input type="button" class="btn btn-default btn-sm" value="Cancel" id="btn-add-category-cancel"></a>
          <input type="submit" class="btn btn-danger btn-sm" value="Delete" name="btn_detail_city">
          <input type="button" class="btn btn-success btn-sm" value="Save Changes" id="btn_alias">
          <input type="submit" class="hidden" value="Save Changes" name="btn_detail_city" id="btn_save">
        </div>
      </div>
    </div>
