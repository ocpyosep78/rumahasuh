            ...
            <div class="subnav clearfix">
              <div class="container clearfix">
                ...
                <div class="btn-placeholder">
                  <a href="<?php echo $prefix_url."add-career"?>">
                 ...
                 <table class="table">
                   <thead>
                     <tr class="headings">
                       ...
                       <th class="sort" width="85%" onclick="sortBy('career_name')">Position<?php echo $arr_order_number;?></th>
                   ...
                   <tbody>
                     ...
                     <td>
					   <a href="<?php echo $prefix_url.'career-detail/'.$all_category['career_id'].'/'.cleanurl($all_category['career_name']);?>">
