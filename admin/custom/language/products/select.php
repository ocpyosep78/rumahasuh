...
function changeLanguage(){
   ...
   var rid  = $('#custom_product_alias').val();
      
   if(lang != "default"){
      location.href = "<?php echo $prefix_url;?>../../../"+lang+"-product-details-"+rid;
   }else{
      location.href = "<?php echo $prefix_url;?>product-details-<?php echo $_REQUEST['product_alias'];?>";
   }
