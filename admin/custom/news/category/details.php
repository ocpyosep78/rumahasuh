...
function update($post_category_name, $post_category_active, $post_category_visibility, $post_category_id){
   $conn   = conndB();
   
   $sql    = "UPDATE tbl_news_category SET `category_name` = '$post_category_name',
...
if(isset($_POST['btn_detail_news_category'])){
 ...
 update($category_name, $active, $visibility, $category_id);
...
include("custom/bridge/news/category/control_bridge.php");
?> 
...
<form method="post" enctype="multipart/form-data">
    ...
    <div class="subnav">
      <div class="container clearfix">
        ...
        <div class="btn-placeholder">
          ...
          <input type="submit" class="hidden" value="Save Changes" name="btn_detail_news_category" id="btn-save">
        </div>
      </div>
    </div>
	...
	if($_POST['btn_detail_news_category'] == ''){
        ...
        <div class="content col-xs-9">
          <ul class="form-set" id="custom_product_category">
            ...
            <li class="form-group row" id="lbl_category_name">
              ...
              <div class="col-xs-9">
                <input type="text" class="form-control" name="category_name" id="category_name" value="<?php echo $detail_category['category_name'];?>">
              </div>
            </li>
          </ul>
        </div>
...
<!--custom-->
<?php
include("custom/language/pages/news/category/index.php");
?> 