    ...
    <div class="subnav">
      <div class="container clearfix">
        <h1>
          ...
          <a href="<?php echo $prefix_url."publications"?>">Publication</a> 
        ...
        <div class="btn-placeholder">
          ...
          <input type="submit" class="hidden" value="Save Changes" name="btn_add_publication" id="btn_save">
        </div>
      </div>
    </div>
        ...
        <div class="content col-xs-9">
          <ul class="form-set" id="custom_product_category">
            ...
            <li class="form-group row" id="lbl_category_name">
              <label class="control-label col-xs-3">Publication Name</label>
              <div class="col-xs-9">
