          ...
          <form method="post">
            <div class="subnav clearfix">
              <div class="container clearfix">
                <h1><span class="glyphicon glyphicon-list"></span> &nbsp; Publications</h1>
                ...
                <div class="btn-placeholder">
                  <a href="<?php echo $prefix_url."add-publications"?>">
                    <input type="button" class="btn btn-success btn-sm" value="Add Publication">
                  </a>
                </div>
              </div>
            </div>
			...
			if($_POST['btn_index_publication'] == ''){
                ...
                <div class="content">
                 ...
                 <div class="actions clearfix">
                   ...
                   <div class="pull-right">
                     ...
                     <input type="submit" class="btn btn-success pull-left" value="GO" name="btn_index_publication">
                   </div>
                 </div><!--actions-->
                 ...
                 <table class="table">
                   <thead>
                     <tr class="headings">
                       ...
                       <th class="sort" width="85%" onclick="sortBy('career_name')">Publication Name<?php echo $arr_order_number;?></th>
                   ...
                   <tbody>
                     ...
                     <td>
					   <a href="<?php echo $prefix_url.'publications-detail/'.$all_category['career_id'].'/'.cleanurl($all_category['career_name']);?>">
