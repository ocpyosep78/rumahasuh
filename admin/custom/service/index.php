...
?>
          <form method="post">
            <div class="subnav clearfix">
              <div class="container clearfix">
                ...
                <div class="btn-placeholder">
                  <a href="<?php echo $prefix_url."add-service-city"?>">
                    <input type="button" class="btn btn-success btn-sm" value="Add City" id="btn-add-category">
                  </a>
                </div>
              </div>
            </div>
			...
			if($_POST['btn_index_service_city'] == ''){
                  ...
                  <div class="actions clearfix">
                   ...
                   <div class="pull-right">
                     <p>Actions</p>
                      ...
                      <input type="submit" class="btn btn-success pull-left" value="GO" name="btn_index_service_city">
                    </div>
                  </div><!--actions-->
                 ...
                 <table class="table">
                   <thead>
                     <tr class="headings">
                       ...
                       <th class="sort" width="85%" onclick="sortBy('category_name')">City<?php echo $arr_order_number;?></th>
                       <!--<th class="sort" width="10%" onclick="sortBy('total_product')">Jobs</th>-->
                       <th class="sort" width="10%">Store</th>
                       <th class="sort" width="5%" onclick="sortBy('visibility')">Visibility</th>
                     </tr>
                     
                     <tr class="filter hidden" id="filter">
                       <th>
                         <a href="<?php echo $prefix_url."service-city"?>">
                   ...
                   <tbody>
                     ...
                     <tr id="<?php echo "row_".$row?>" onclick="selectRow('<?php echo $row;?>')">
                       ...
                       <td><a href="<?php echo $prefix_url.'service-city-detail/'.$all_category['category_id'].'/'.cleanurl($all_category['category_name']);?>"><?php echo $all_category['category_name'];?></a></td>
