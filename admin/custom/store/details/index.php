...
<form method="post" enctype="multipart/form-data">
    ...
    <div class="subnav">
      <div class="container clearfix">
        <h1>
          ...
          <a href="<?php echo $prefix_url."store-city"?>">City</a> 
        ...
        <div class="btn-placeholder">
          ...
          <input type="submit" class="btn btn-danger btn-sm" value="Delete" name="btn_detail_store_city">
          <input type="button" class="btn btn-success btn-sm" value="Save Changes" id="btn_alias">
          <input type="submit" class="hidden" value="Save Changes" name="btn_detail_store_city" id="btn_save">
        </div>
      </div>
    </div>
	...
	if($_POST['btn_detail_store_city'] == ''){
