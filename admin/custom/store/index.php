            ...
            <div class="subnav clearfix">
              <div class="container clearfix">
                ...
                <div class="btn-placeholder">
                  <a href="<?php echo $prefix_url."add-city"?>">
                  ...
                  <div class="actions clearfix">
                   ...
                   <div class="pull-right">
                     <p>Actions</p>
                      ...
                      <input type="submit" class="btn btn-success pull-left" value="GO" name="btn_index_store_city">
                    </div>
                  </div><!--actions-->
                 ...
                 <table class="table">
                   <thead>
                     ...
                     <tr class="filter hidden" id="filter">
                       <th>
                         <a href="<?php echo $prefix_url."store-city"?>">
                   ...
                   <tbody>
                     ...
                     <tr id="<?php echo "row_".$row?>" onclick="selectRow('<?php echo $row;?>')">
                       ...
                       <td><a href="<?php echo $prefix_url.'store-city-detail/'.$all_category['category_id'].'/'.cleanurl($all_category['category_name']);?>"><?php echo $all_category['category_name'];?></a></td>
                       <td>
