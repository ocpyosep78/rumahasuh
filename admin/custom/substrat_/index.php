            ...
            <div class="subnav clearfix">
              <div class="container clearfix">
                ...
                <div class="btn-placeholder">
                  <a href="<?php echo $prefix_url."add-filter-substrat"?>">
                ...
                <div class="content">
                 ...
                 <div class="actions clearfix">
                   ...
                   <div class="pull-right">
                     ...
                     <input type="submit" class="btn btn-success pull-left" value="GO" name="btn_index_filter_sub">
                   </div>
                 </div><!--actions-->
                 ...
                 <table class="table">
                   ...
                   <tbody>
                     ...
                     <td>
					   <a href="<?php echo $prefix_url.'filter-substrat-detail/'.$all_category['filter_id'].'/'.cleanurl($all_category['filter_name']);?>">
