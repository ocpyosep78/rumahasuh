...
if(isset($_POST['btn_detail_tag'])){
   
   if($_POST['btn_detail_tag'] == 'Delete'){
      
   }else if($_POST['btn_detail_tag'] == 'Save Changes'){
      update_category();
...
function update_category(){
   ...
   if ($category_parent=='top'){
      ...
      $get_level = mysql_query("SELECT * from tbl_tag WHERE category_id = '$category_parent'",$conn);
   ...
   mysql_query(" UPDATE tbl_tag  SET category_name = '$category_name',
...
function update_category_relation($category_id,$category_parent){
   ...
   mysql_query("DELETE FROM tbl_tag_relation WHERE category_child = '$category_id'",$conn);
   ...
   $categories=array();
   $get_categories = mysql_query("SELECT * from tbl_tag_relation WHERE category_parent = '$category_id'",$conn);
   ...
   foreach($categories as $category){
	  ...
	  mysql_query("DELETE FROM tbl_tag_relation WHERE category_child = '$tmp_child' AND relation_level >= '$tmp_level'" ,$conn);
...
function add_category_relation($category_id,$category_parent,$level_init){
   ...
   if ($category_parent=='top'){
      mysql_query("INSERT INTO tbl_tag_relation(category_child,category_parent,relation_level) VALUES('$category_id','$category_parent','$level_init')",$conn);
   }else{
      $parent_array=array();
   ...
   mysql_query("UPDATE tbl_tag SET category_level = '$category_level' WHERE category_id = '$category_id'");
}
?> 
    ...
    <div class="subnav">
      <div class="container clearfix">
        ...
        <div class="btn-placeholder">
          ...
          <input type="submit" class="btn btn-success btn-sm" value="Save Changes" name="btn_detail_tag" id="btn-save">
        </div>
      </div>
    </div>
