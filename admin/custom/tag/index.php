          ...
          <form method="post" enctype="multipart/form-data">      
            ...
            <div class="subnav clearfix">
              <div class="container clearfix">
                <h1><span class="glyphicon glyphicon-list"></span> &nbsp; Color</h1>
                <div class="btn-placeholder">
                  <a href="<?php echo $prefix_url."add-tag"?>">
                    <input type="button" class="btn btn-success btn-sm" value="Add Color" name="btn_add_tag" id="d_btn_add_tag">
                  </a>
                </div>
              </div>
            </div>
                ...
                <div class="content">
                 ...
                 <div class="actions clearfix">
                   ...
                   <div class="pull-right">
                     ...
                     <input type="submit" class="btn btn-success pull-left" value="GO" name="btn_index_tag">
                   </div>
                 </div><!--actions-->
                 ...
                 <table class="table" id="tbl_category">
				   ...
				   ?>
                      <tr id="<?php echo "row_".$row?>" onclick="selectRow('<?php echo $row;?>')">
                        ...
                        <td>
                          <a href="<?php echo $prefix_url."child-tag/".$all_category['category_id']."/".cleanurl($all_category['category_name']);?>">
