...
if(isset($_POST['btn_add_tagging'])){
$conn = connDB();
    ...
    <div class="subnav">
      <div class="container clearfix">
        <h1>
          ...
          <a href="<?php echo $prefix_url."tagging"?>">Color (Wood)</a> 
          <span class="info">/</span> Add Color
        </h1>
        <div class="btn-placeholder">
          <input type="hidden" name="cat_id" id="category_id"/>
          <a href="<?php echo $prefix_url."tagging";?>">
            <input type="button" class="btn btn-default btn-sm" value="Cancel" id="btn-add-category-cancel">
          </a>
          <input type="submit" class="btn btn-success btn-sm" value="Save Changes" name="btn_add_tagging" id="btn-save">
        </div>
      </div>
    </div>
