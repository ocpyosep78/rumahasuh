            ...
            <div class="subnav clearfix">
              <div class="container clearfix">
                <h1>
                  ...
                  <a href="<?php echo $prefix_url."tagging"?>">Color</a> 
                  <span class="info">/</span> <?php echo $parent['category_name'];?>
                </h1>
                <div class="btn-placeholder">
                  <a href="<?php echo $prefix_url."tagging";?>"><input type="button" class="btn btn-default btn-sm" value="Back" id="btn-add-category-cancel"></a>
                  <a href="<?php echo $prefix_url."add-tagging"?>"><input type="button" class="btn btn-success btn-sm" value="Add Category" /></a>
                </div>
              </div>
            </div>
                ...
                <div class="content">
                 ...
                 <div class="actions clearfix">
                   ...
                   <div class="pull-right">
                     ...
                     <input type="submit" class="btn btn-success pull-left" value="GO" name="btn_child_tagging">
                   </div>
                 </div><!--actions-->
                 ...
                 <table class="table" id="tbl_category">
                   <thead>
                     <tr class="headings">
                       ...
                       <th class="sort" width="85%" onclick="sortBy('category_name')">Color Name<?php echo $arr_order_number;?></th>
                     ...
                     <tr class="filter hidden" id="filter">
                       <th><a href="<?php echo $prefix_url."child-tagging/".$_REQUEST['cid']."/".$_REQUEST['cname'];?>"><button type="button" style="width: 100%;" class="btn btn-danger btn-xs <?php echo $reset;?>"><span class="glyphicon glyphicon-remove"></span></button></a></th>
				   ...
				   ?>
                      <tr id="<?php echo "row_".$row?>" onclick="selectRow('<?php echo $row;?>')">
                        ...
                        <td>
                          <a href="<?php echo $prefix_url."child-tagging/".$all_category['category_id']."/".cleanurl($all_category['category_name']);?>" onclick="freechecked()">
						     <?php for($i=0;$i<$all_category['category_level'];$i++){ echo "-- ";} echo $all_category['category_name'];?></a> &nbsp;
                             
                             <a href="<?php echo $prefix_url."detail-tagging/".$all_category['category_id']."/".cleanurl($all_category['category_name']);?>">
