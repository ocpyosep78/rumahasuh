          ...
          <form method="post" enctype="multipart/form-data">      
            ...
            <div class="subnav clearfix">
              <div class="container clearfix">
                <h1><span class="glyphicon glyphicon-list"></span> &nbsp; Color (Wood)</h1>
                <div class="btn-placeholder">
                  <a href="<?php echo $prefix_url."add-tagging"?>">
                    <input type="button" class="btn btn-success btn-sm" value="Add Color">
                  </a>
                </div>
              </div>
            </div>
                ...
                <div class="content">
                 ...
                 <div class="actions clearfix">
                   ...
                   <div class="pull-right">
                     ...
                     <input type="submit" class="btn btn-success pull-left" value="GO" name="btn_index_tagging">
                   </div>
                 </div><!--actions-->
                 ...
                 <table class="table" id="tbl_category">
				   ...
				   ?>
                      <tr id="<?php echo "row_".$row?>" onclick="selectRow('<?php echo $row;?>')">
                        ...
                        <td>
                          <a href="<?php echo $prefix_url."child-tagging/".$all_category['category_id']."/".cleanurl($all_category['category_name']);?>">
