<form method="post" enctype="multipart/form-data">
    ...
    <div class="subnav">
      <div class="container clearfix">
        <h1><span class="glyphicon glyphicon-tint"></span> &nbsp; <a href="http://<?php echo $_SERVER['HTTP_HOST'].get_dirname($_SERVER['PHP_SELF'])."/color"?>">Color Groups</a> <span class="info">/</span> Edit Color</h1>
