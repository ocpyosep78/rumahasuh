          ...
          <table class="table" id="tbl_products">
            <thead>
              <tr class="headings">
                ...
                <th width="30"></th>
                <th class="sort" width="95%" onclick="sortBy('product_name')">Item<?php echo $arr_product_name;?></th>
                <th class="sort hidden" width="20%" onclick="sortBy('type_name')">Variants<?php echo $arr_type_name;?></th>
                <th class="sort hidden" width="20%" onclick="sortBy('type_price')">Price<?php echo $arr_type_price;?></th>
            ...
            <tbody>
              ...
              <tr id="<?php echo "row_".$row?>" onclick="selectRow('<?php echo $row;?>')">
                ...
                <td><img class="table-image" src="<?php echo $prefix_url.'static/thimthumb.php?src=../'.$all_product['img_src'].'&h=45&w=30&q=80';?>"></td>
                <td>
                ...
                <td class="hidden"><?php echo ucwords(strtolower($all_product['type_name']));?></td>
                <td class="hidden"><?php echo price($all_product['type_price']);?></td>
