<form method="post" enctype="multipart/form-data">
    ...
    <div class="subnav">
      <div class="container clearfix">
        <h1><span class="glyphicon glyphicon-pushpin"></span> &nbsp; <a href="http://<?php echo $_SERVER['HTTP_HOST'].get_dirname($_SERVER['PHP_SELF'])."/size"?>">Size Groups</a> <span class="info">/</span> Edit Size Group</h1>
        <div class="btn-placeholder">
          <input type="hidden" name="cat_id" id="category_id"/>
          <a href="http://<?php echo $_SERVER['HTTP_HOST'].get_dirname($_SERVER['PHP_SELF'])."/size";?>"><input type="button" class="btn btn-default btn-sm" value="Cancel"></a>
          <input type="button" class="btn btn-danger btn-sm" value="Delete">
          <input type="submit" class="btn btn-success btn-sm" value="Save Changes" name="btn-index-size" id="btn-save">
        </div>
      </div>
    </div>
        ...
        <div class="content col-xs-9">
          <ul class="form-set">
            <li class="form-group row">
              ...
              <div class="col-xs-9">
                <label class="radio-inline">
                  <input type="radio" value="Active" id="size-active" name="size_active">
                  Active
                </label>
                <label class="radio-inline">
            ...
            <li class="form-group row">
              ...
              <div class="col-xs-9">
                <label class="radio-inline">
                  <input type="radio" value="Yes" id="size-visible" name="size_visibility">
                  Yes
                </label>
                <label class="radio-inline">
                  <input type="radio" value="No" id="size-invisible" name="size_visibility">
                  No
                </label>
              </div>
            </li>
            <li class="form-group row">
              ...
              <div class="col-xs-9">
                <input type="text" class="form-control" id="edit-size-type-name" name="size_type_name">
