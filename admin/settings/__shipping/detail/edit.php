...
<form method="post">
            ...
            <div class="sub-header clearfix">
                    <div class="content">
                        ...
                        <div class="btn-placeholder">
                            <a href="<?php echo $prefix_url."shipping/".$ship_id;?>">
                            ...
                            <input type="button" class="btn red main hidden" value="Delete"  onclick="validationAddShipping('exit')">
                            
                            <input type="submit" class="btn green main" value="Save Changes" name="btn-edit-shipping" id="btn-save">
                            <input type="submit" class="btn green main" value="Save Changes &amp; Exit" name="btn-edit-shipping" id="btn-save-exit">
                        </div>
                    </div>
                </div>
            ...
            <div id="main-content">
                    ...
                    <div class="content basic-details" >
                        <ul class="field-set">
                            <li class="field">
                                ...
                                <input type="text" class="input-text" placeholder="e.g., JNE (Regular)" name="courier_name" id="id_courier_name" value="<?php echo $courier['courier_name'];?>">
                                </div>
                            </li>
                            <li class="field">
                                ...
                                <input type="text" class="input-text" placeholder="e.g., Regular Shipping (2-3 days delivery)" name="description" id="id_description" value="<?php echo $courier['courier_description'];?>">
                                </div>
                            </li>
                            <li class="field">
                                ...
                                <select class="input-select" id="id_service" name="courier_service" onchange="selectService()">
                                    ...
                                    <option disabled="disabled" value="International Only" disabled="disabled">International only</option>
                                    <option disabled="disabled" value="Local &amp; International" disabled="disabled">Local &amp; International</option>
                                </select>
                    ...
                    <div class="content">
                                ...
                                <ul style="margin-bottom: 20px">
                                    ...
                                    <li class="field field-checkbox clearfix" onclick="selectCity('<?php //echo $row;?>')">
                                        <div class="fl" style="width: 250px; padding-top: 5px">
                                            ...
                                            <input type="checkbox" class="input-checkbox" value="<?php echo $city['courier_rate_id'];?>" style="top: 14px;" id="city-checkbox-<?php echo $row;?>" name="city_name[]" attribute="attribute-<?php echo $row?>" checked="checked">
                                        </div>
                                        <div class="fr" style="width: 220px">
                                            ...
                                            <input type="text" name="courier_rate[]" class="input-text fl" style="width: 100px" placeholder="0" value="<?php echo price($city['courier_rate']);?>" onfocus="focusCheckbox(<?php //echo $city['courier_rate_id']?>)" onkeyup="focusCheckbox(<?php //echo $city['courier_rate_id']?>)" id="courier_rate_<?php echo $row;?>" checked="checked">
                                            ...
                                            <p class="fl" style="width: 60px; margin-left: 10px" id="per_weight"> / <?php echo $city['courier_weight'];?> kg</p>
                                            </span>
						...
						?>
                            ...
                            <li class="field field-checkbox clearfix">
                                ...
                                <div class="fr" style="width: 220px">
                                    <p class="fl" style="width: 30px; margin-right: 10px">IDR</p>
                                    <input type="text" class="input-text fl" style="width: 100px" placeholder="0" onfocus="checkIt('<?php echo $row;?>')" name="international_rate[]" id="intl-rate-<?php echo $row;?>" value="<?php echo price($international['courier_rate']);?>">
                                    <!--<p><?php echo "IDR ".price($international['courier_rate'])." / ".$international['courier_weight']."Kg";?></p>-->
                                    
                                    <span class="custom-weight">
                                    <p class="fl" style="width: 60px; margin-left: 10px" id="per_weight"> / <?php echo $international['courier_weight'];?> kg</p>
                                    </span>
                ...
                <!--<div class="box clearfix hidden" id="international">
                    <div class="desc">
                        <h3>International Shipping</h3>
