...
<form method="post">
            ...
            <div class="subnav">
                    <div class="container clearfix">
                        <h1><span class="glyphicon glyphicon-road"></span> &nbsp; <a href="http://<?php echo $_SERVER['HTTP_HOST'].get_dirname($_SERVER['PHP_SELF'])."/shipping"?>">Shipping Methods</a> <span class="info">/</span> Edit Shipping Method</h1>
